...
class AboutAttributeAccess(Koan):
    ...
    def test_getattribute_is_a_bit_overzealous_sometimes(self):
        ...
        catcher.my_method() # go __getattribute__
        global stack_depth
        self.assertEqual(11, stack_depth) # line:101, we accessed attribute, so call __getattribute__, call again, recursively, stack_depth==11, we return
